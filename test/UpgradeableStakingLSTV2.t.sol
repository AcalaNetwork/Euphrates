...
contract UpgradeableStakingLSTV2Harness is UpgradeableStakingLSTV2 {
...
contract UpgradeableStakingLSTV2Test is Test {
    ...
    UpgradeableStakingLSTV2Harness public staking;
    ...
    function setUp() public {
        ...
        staking = new UpgradeableStakingLSTV2Harness();
        vm.prank(ADMIN);
        staking.initialize(
            address(dot),
            address(lcdot),
    ...
    function test_convertLSTPool_LCDOT2LDOT() public {
        ...
        assertEq(
            address(staking.poolConvertors(0)),
            address(lcdot2ldotConvertor)
        );
    ...
    function test_stakeTo_works() public {
        ...
        assertEq(staking.earned(0, BOB, dot), 500_000 ether);
        assertEq(
            staking.paidAccumulatedRates(0, BOB, dot),
            (500 ether * 1000 * 1e18) / 200_000 ether
        );
        assertEq(
            staking.rewardPerShare(0, dot),
